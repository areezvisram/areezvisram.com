    ...
    return (
        <div className="projects-container" id="projects">
            <div className="projects-all">
                ...
                <IndividualProject projectTitle={'Verilog Combination Lock'} description={'Designed a Moore finite state machine that implements the functionality of a combination lock alarm system. Implemented in the Verilog HDL. FSM design can be found in GitHub README.'} languages={'Verilog'} githubLink={'https://github.com/areezvisram/Verilog-Combo-Lock-FSM'} />
