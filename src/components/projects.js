    ...
    return (
        <div className="projects-container" id="projects">
            <div className="projects-all">
                ...
                <IndividualProject projectTitle={'NHL Fantasy Recommender'} description={'Utilizes the NHL API to recommend best players for NHL fantasy teams. Incorporates a detailed algorithm to suggest best players for fantasy purposes. Allows building of preview fantasy teams. Currently in progress.'} languages={'JavaScript ElectronJS HTML/CSS'}/>
